...
const enMessages = {
  ...
  settingsModal: {
    ...
    agentTab: {
      description: "Choose the command-line agent used for conversations. The change applies to the next turn.",
      backendLabel: "Conversation backend",
      helperText: "Auto prefers Claude Code for compatibility and uses Codex when Claude is unavailable. Codex requires an authenticated `codex` CLI on PATH.",
      configured: "Backend: {backend}",
      backend: {
        auto: "Auto (Claude first)",
